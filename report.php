		  	...
		  	<div class="container-fluid">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			      	<ul class="nav navbar-nav">
			        	...
			        	<li class = "active"><a href="report.php" class = "active-page">Generate Report</a></li>
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
                    ...
                    <a href="#" class="active" id="product-form-link">Report Detail</a>
						...
						<?php
										echo "Current lab = ".$_SESSION['lab_name']."<br><br>";
									...
									?>	   
	<form method="post" action = "report1.php" id="report-form" >
        ...
        <div class="form-group col-md-3 container"><input type="checkbox" name="address">Address of Vendor<br></div>
         ...
         <div class="row col-md-12">	
         	<label>Generate Report For:</label><br>
         </div>
         <div class = "row">	
                <div class="form-group col-md-6 inp2"><input type="radio" required name="whom" value="current">Current Lab</div>
                <div class="form-group col-md-6 inp2"><input type="radio" required name="whom" value="all">All Labs</div>
         </div>
										<div class="row">
