<?php 
	...
	if($_SESSION['auth'] && $_SESSION['role'] == 'admin'){
		...
		$query2 = "SELECT staff_id,name,phone,username,email FROM staff WHERE lab_id = $lab_id AND role='lab'";
		$result2 = mysqli_query($link,$query2);
		$query3 = "SELECT staff_id,name,phone,username,email FROM staff WHERE lab_id = $lab_id AND role='incharge'";
		...
		if(isset($_POST['incharge'])){
			...
			if(isset($_POST['name']) && isset($_POST['phone']) && isset($_POST['email']) && isset($_POST['password']) && isset($_POST['password1'])){
				...
				if($big == 0){
					$password = password_hash($password, PASSWORD_DEFAULT);
					$query1 = "UPDATE staff set name = '$name', phone = '$phone', username = '$username',password = '$password', email = '$email' WHERE staff_id = $staff_id1";
					$res1 = mysqli_query($link,$query1);
					
					$query6 =  "UPDATE lab SET lab_incharge = '$name' WHERE lab_id = $lab_id";
			  	...
			  	<div class="container-fluid">
				    ...
				    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				      	<ul class="nav navbar-nav">
				        	...
				        	<li class = "active"><a href="newuser.php" class = "active-page">Add new user</a></li>
				...
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							...
							<div class="col-xs-6">
								<a href="#" id="vendor-form-link">Update Lab Incharge</a>
							</div>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
										...
										<div class="form-group">
											<div class="row">
												<div class="col-md-12 sbm"><br><br>
													<input type="submit" name="assistant" class="form-control btn btn-register" style="width : 150px;">
												</div>
											</div>
										</div>
								...
								<form method="post" action="" >
									<div class="tabcontent" id="vendor-form" style="display: none;">
										<div style="color: #68100d; text-align: center;">
											<?php 
											if(isset($_SESSION['res'])){
												echo $_SESSION['res'].'<br>';
										...
										<br>
										<div class="form-group col-md-4 container">
										<label>Name:<input type="text" class="form-control" required  name="name" value = '<?php echo $name1; ?>'></label>
										</div>
	                                    <div class="form-group col-md-4 container">
											<label>Phone No:<input type="text" class="form-control" required  name="phone" value = '<?php echo $phone1; ?>'></label>
										</div>
	                                    <div class="form-group col-md-4 container">
											<label>Username:<input type="text" class="form-control" required  name="username" value = '<?php echo $username1; ?>'></label>
										</div>
	                                    <div class="form-group col-md-4 container">
											<label>Email-Id:<input type="email" class="form-control" required  name="email" value = '<?php echo $email1; ?>'></label>
										</div>
	                                    <div class="form-group col-md-4 container">
											<label>Password:<input type="password" class="form-control" required  name="password"></label>
										</div>
										...
										<div class="form-group">
											<div class="row">
												<div class="col-md-12 sbm"><br><br>
													<input type="submit" name="incharge" class="form-control btn btn-register" style="width : 150px;">
												</div>
											</div>
										</div>
