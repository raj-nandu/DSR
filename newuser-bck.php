<?php 
	...
	if($_SESSION['auth'] && $_SESSION['role'] == 'admin'){
		...
		$query = "SELECT staff_id FROM lab WHERE lab_id = '$lab_id'";
		$res = mysqli_query($link,$query);
		while($row = $res->fetch_assoc()){
			$staff_id = $row['staff_id'];
		}
		$query2 = "SELECT name,phone,username,email FROM staff WHERE staff_id = $staff_id";
		...
		if($_POST){
			...
			if(isset($_POST['name']) && isset($_POST['phone']) && isset($_POST['email']) && isset($_POST['password']) && isset($_POST['password1'])){
				...
				if($big == 0){
					$query1 = "UPDATE staff set name = '$name', phone = '$phone', username = '$username',password = '$password', email = '$email', role = 'lab' WHERE staff_id = $staff_id";
		  	...
		  	<div class="container-fluid">
			    ...
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			      	<ul class="nav navbar-nav">
			        	...
			        	<li class = "active"><a href="newuser.php">Add new user</a></li>
